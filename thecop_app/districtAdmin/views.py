...
def home(request):
    ...
    context = {
        ...
        # --------------------------------------------------------------#
        "adults_count": active_admin.district.get_adults_count()[0],
        "adults_count_male": active_admin.district.get_adults_count()[1],
        "adults_count_female": active_admin.district.get_adults_count()[2],
        # --------------------------------------------------------------#
        "youth_count": active_admin.district.get_youth_count()[0],
        "youth_count_male": active_admin.district.get_youth_count()[1],
        "youth_count_female": active_admin.district.get_youth_count()[2],
        # --------------------------------------------------------------#
        "children_count": active_admin.district.get_children_count()[0],
        "children_count_male": active_admin.district.get_children_count()[1],
        "children_count_female": active_admin.district.get_children_count()[2]
        # --------------------------------------------------------------#
    }
